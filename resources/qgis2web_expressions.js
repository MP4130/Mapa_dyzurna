...
function exp_entitiesL_2rule5_eval_expression(context) {
    // ogr_style = 'PEN(c:#000000,w:0.18g,p:"1.5g 0.5g")'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('ogr_style')  == 'PEN(c:#000000,w:0.18g,p:"1.5g 0.5g")');
    } else {
        return (feature.get('ogr_style')  == 'PEN(c:#000000,w:0.18g,p:"1.5g 0.5g")');
    }
}
...
function exp_entitiesL_2rule8_eval_expression(context) {
    // ogr_style = 'PEN(c:#000000,w:0.35g)'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('ogr_style')  == 'PEN(c:#000000,w:0.35g)');
    } else {
        return (feature.get('ogr_style')  == 'PEN(c:#000000,w:0.35g)');
    }
}
...
function exp_entitiesL_2rule13_eval_expression(context) {
    // ogr_style = 'PEN(c:#003fff)'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('ogr_style')  == 'PEN(c:#003fff)');
    } else {
        return (feature.get('ogr_style')  == 'PEN(c:#003fff)');
    }
}
...
function exp_entitiesL_2rule14_eval_expression(context) {
    // ogr_style = 'PEN(c:#004c00,w:0.25g)'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('ogr_style')  == 'PEN(c:#004c00,w:0.25g)');
    } else {
        return (feature.get('ogr_style')  == 'PEN(c:#004c00,w:0.25g)');
    }
}
...
function exp_entitiesL_2rule15_eval_expression(context) {
    // ogr_style = 'PEN(c:#007f7f,w:0.13g)'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('ogr_style')  == 'PEN(c:#007f7f,w:0.13g)');
    } else {
        return (feature.get('ogr_style')  == 'PEN(c:#007f7f,w:0.13g)');
    }
}
...
function exp_entitiesL_2rule16_eval_expression(context) {
...
function exp_entitiesL_2rule17_eval_expression(context) {
...
function exp_entitiesL_2rule18_eval_expression(context) {
    // ogr_style = 'PEN(c:#00ff00,w:0.09g)'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('ogr_style')  == 'PEN(c:#00ff00,w:0.09g)');
    } else {
        return (feature.get('ogr_style')  == 'PEN(c:#00ff00,w:0.09g)');
    }
}
...
function exp_entitiesL_2rule19_eval_expression(context) {
    // ogr_style = 'PEN(c:#00ff00,w:0.13g)'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('ogr_style')  == 'PEN(c:#00ff00,w:0.13g)');
    } else {
        return (feature.get('ogr_style')  == 'PEN(c:#00ff00,w:0.13g)');
    }
}
...
function exp_entitiesL_2rule20_eval_expression(context) {
    // ogr_style = 'PEN(c:#00ff00,w:0.15g)'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('ogr_style')  == 'PEN(c:#00ff00,w:0.15g)');
    } else {
        return (feature.get('ogr_style')  == 'PEN(c:#00ff00,w:0.15g)');
    }
}
...
function exp_entitiesL_2rule21_eval_expression(context) {
    // ogr_style = 'PEN(c:#00ff00,w:0.2g)'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('ogr_style')  == 'PEN(c:#00ff00,w:0.2g)');
    } else {
        return (feature.get('ogr_style')  == 'PEN(c:#00ff00,w:0.2g)');
    }
}
...
function exp_entitiesL_2rule22_eval_expression(context) {
    // ogr_style = 'PEN(c:#00ff00,w:0.35g)'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('ogr_style')  == 'PEN(c:#00ff00,w:0.35g)');
    } else {
        return (feature.get('ogr_style')  == 'PEN(c:#00ff00,w:0.35g)');
    }
}
...
function exp_entitiesL_2rule23_eval_expression(context) {
...
function exp_entitiesL_2rule24_eval_expression(context) {
    // ogr_style = 'PEN(c:#26d94f,w:0.25g)'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('ogr_style')  == 'PEN(c:#26d94f,w:0.25g)');
    } else {
        return (feature.get('ogr_style')  == 'PEN(c:#26d94f,w:0.25g)');
    }
}
...
function exp_entitiesL_2rule25_eval_expression(context) {
...
function exp_entitiesL_2rule26_eval_expression(context) {
    // ogr_style = 'PEN(c:#4c2600,w:0.35g)'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('ogr_style')  == 'PEN(c:#4c2600,w:0.35g)');
    } else {
        return (feature.get('ogr_style')  == 'PEN(c:#4c2600,w:0.35g)');
    }
}
...
function exp_entitiesL_2rule27_eval_expression(context) {
...
function exp_entitiesL_2rule28_eval_expression(context) {
...
function exp_entitiesL_2rule29_eval_expression(context) {
...
function exp_entitiesL_2rule30_eval_expression(context) {
    // ogr_style = 'PEN(c:#7ca500,w:0.3g)'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('ogr_style')  == 'PEN(c:#7ca500,w:0.3g)');
    } else {
        return (feature.get('ogr_style')  == 'PEN(c:#7ca500,w:0.3g)');
    }
}
...
function exp_entitiesL_2rule31_eval_expression(context) {
...
function exp_entitiesL_2rule32_eval_expression(context) {
...
function exp_entitiesL_2rule33_eval_expression(context) {
    // ogr_style = 'PEN(c:#7f7f7f,w:0.4g)'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('ogr_style')  == 'PEN(c:#7f7f7f,w:0.4g)');
    } else {
        return (feature.get('ogr_style')  == 'PEN(c:#7f7f7f,w:0.4g)');
    }
}
...
function exp_entitiesL_2rule34_eval_expression(context) {
    // ogr_style = 'PEN(c:#7fff9f,w:0.25g)'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('ogr_style')  == 'PEN(c:#7fff9f,w:0.25g)');
    } else {
        return (feature.get('ogr_style')  == 'PEN(c:#7fff9f,w:0.25g)');
    }
}
...
function exp_entitiesL_2rule35_eval_expression(context) {
    // ogr_style = 'PEN(c:#7fffdf,w:0.25g)'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('ogr_style')  == 'PEN(c:#7fffdf,w:0.25g)');
    } else {
        return (feature.get('ogr_style')  == 'PEN(c:#7fffdf,w:0.25g)');
    }
}
...
function exp_entitiesL_2rule36_eval_expression(context) {
    // ogr_style = 'PEN(c:#803300)'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('ogr_style')  == 'PEN(c:#803300)');
    } else {
        return (feature.get('ogr_style')  == 'PEN(c:#803300)');
    }
}
...
function exp_entitiesL_2rule37_eval_expression(context) {
    // ogr_style = 'PEN(c:#803300,w:0.18g)'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('ogr_style')  == 'PEN(c:#803300,w:0.18g)');
    } else {
        return (feature.get('ogr_style')  == 'PEN(c:#803300,w:0.18g)');
    }
}
...
function exp_entitiesL_2rule38_eval_expression(context) {
    // ogr_style = 'PEN(c:#803300,w:0.25g)'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('ogr_style')  == 'PEN(c:#803300,w:0.25g)');
    } else {
        return (feature.get('ogr_style')  == 'PEN(c:#803300,w:0.25g)');
    }
}
...
function exp_entitiesL_2rule39_eval_expression(context) {
    // ogr_style = 'PEN(c:#803300,w:0.2g)'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('ogr_style')  == 'PEN(c:#803300,w:0.2g)');
    } else {
        return (feature.get('ogr_style')  == 'PEN(c:#803300,w:0.2g)');
    }
}
...
function exp_entitiesL_2rule40_eval_expression(context) {
...
function exp_entitiesL_2rule41_eval_expression(context) {
...
function exp_entitiesL_2rule42_eval_expression(context) {
...
function exp_entitiesL_2rule43_eval_expression(context) {
    // ogr_style = 'PEN(c:#989898,w:0.4g)'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('ogr_style')  == 'PEN(c:#989898,w:0.4g)');
    } else {
        return (feature.get('ogr_style')  == 'PEN(c:#989898,w:0.4g)');
    }
}
...
function exp_entitiesL_2rule44_eval_expression(context) {
...
function exp_entitiesL_2rule45_eval_expression(context) {
    // ogr_style = 'PEN(c:#a500a5,w:0.35g)'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('ogr_style')  == 'PEN(c:#a500a5,w:0.35g)');
    } else {
        return (feature.get('ogr_style')  == 'PEN(c:#a500a5,w:0.35g)');
    }
}
...
function exp_entitiesL_2rule46_eval_expression(context) {
    // ogr_style = 'PEN(c:#bf7fff,w:0.25g)'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('ogr_style')  == 'PEN(c:#bf7fff,w:0.25g)');
    } else {
        return (feature.get('ogr_style')  == 'PEN(c:#bf7fff,w:0.25g)');
    }
}
...
function exp_entitiesL_2rule47_eval_expression(context) {
    // ogr_style = 'PEN(c:#bfbf00,w:0.18g)'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('ogr_style')  == 'PEN(c:#bfbf00,w:0.18g)');
    } else {
        return (feature.get('ogr_style')  == 'PEN(c:#bfbf00,w:0.18g)');
    }
}
...
function exp_entitiesL_2rule48_eval_expression(context) {
    // ogr_style = 'PEN(c:#bfbf00,w:0.2g)'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('ogr_style')  == 'PEN(c:#bfbf00,w:0.2g)');
    } else {
        return (feature.get('ogr_style')  == 'PEN(c:#bfbf00,w:0.2g)');
    }
}
...
function exp_entitiesL_2rule49_eval_expression(context) {
    // ogr_style = 'PEN(c:#d200d2,w:0.18g)'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('ogr_style')  == 'PEN(c:#d200d2,w:0.18g)');
    } else {
        return (feature.get('ogr_style')  == 'PEN(c:#d200d2,w:0.18g)');
    }
}
...
function exp_entitiesL_2rule50_eval_expression(context) {
    // ogr_style = 'PEN(c:#d200d2,w:0.2g)'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('ogr_style')  == 'PEN(c:#d200d2,w:0.2g)');
    } else {
        return (feature.get('ogr_style')  == 'PEN(c:#d200d2,w:0.2g)');
    }
}
...
function exp_entitiesL_2rule51_eval_expression(context) {
...
function exp_entitiesL_2rule52_eval_expression(context) {
...
function exp_entitiesL_2rule53_eval_expression(context) {
...
function exp_entitiesL_2rule54_eval_expression(context) {
...
function exp_entitiesL_2rule55_eval_expression(context) {
...
function exp_entitiesL_2rule56_eval_expression(context) {
...
function exp_entitiesL_2rule57_eval_expression(context) {
    // ogr_style = 'PEN(c:#ff9100,w:0.18g)'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('ogr_style')  == 'PEN(c:#ff9100,w:0.18g)');
    } else {
        return (feature.get('ogr_style')  == 'PEN(c:#ff9100,w:0.18g)');
    }
}
...
function exp_entitiesL_2rule58_eval_expression(context) {
    // ogr_style = 'PEN(c:#ff9100,w:0.2g)'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('ogr_style')  == 'PEN(c:#ff9100,w:0.2g)');
    } else {
        return (feature.get('ogr_style')  == 'PEN(c:#ff9100,w:0.2g)');
    }
}
...
function exp_entitiesL_2rule59_eval_expression(context) {
...
function exp_entitiesL_2rule60_eval_expression(context) {
...
function exp_entitiesL_4rule6_eval_expression(context) {
    // ogr_style = 'PEN(c:#000000,w:0.5g)'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('ogr_style')  == 'PEN(c:#000000,w:0.5g)');
    } else {
        return (feature.get('ogr_style')  == 'PEN(c:#000000,w:0.5g)');
    }
}
...
function exp_entitiesL_4rule7_eval_expression(context) {
    // ogr_style = 'PEN(c:#00000000,w:0.18g)'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('ogr_style')  == 'PEN(c:#00000000,w:0.18g)');
    } else {
        return (feature.get('ogr_style')  == 'PEN(c:#00000000,w:0.18g)');
    }
}
...
function exp_entitiesL_4rule8_eval_expression(context) {
    // ogr_style = 'PEN(c:#00000000,w:0.3g)'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('ogr_style')  == 'PEN(c:#00000000,w:0.3g)');
    } else {
        return (feature.get('ogr_style')  == 'PEN(c:#00000000,w:0.3g)');
    }
}
...
function exp_entitiesL_6rule1_eval_expression(context) {
    // ogr_style = 'PEN(c:#000000,w:0.13g,p:"0.5g 0.5g")'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('ogr_style')  == 'PEN(c:#000000,w:0.13g,p:"0.5g 0.5g")');
    } else {
        return (feature.get('ogr_style')  == 'PEN(c:#000000,w:0.13g,p:"0.5g 0.5g")');
    }
}
...
function exp_entitiesL_6rule5_eval_expression(context) {
    // ogr_style = 'PEN(c:#803300,w:0.13g)'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('ogr_style')  == 'PEN(c:#803300,w:0.13g)');
    } else {
        return (feature.get('ogr_style')  == 'PEN(c:#803300,w:0.13g)');
    }
}
...
function exp_entitiesL_6rule8_eval_expression(context) {
    // ogr_style = 'PEN(c:#bfbf00,w:0.13g)'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('ogr_style')  == 'PEN(c:#bfbf00,w:0.13g)');
    } else {
        return (feature.get('ogr_style')  == 'PEN(c:#bfbf00,w:0.13g)');
    }
}
...
function exp_entitiesL_6rule11_eval_expression(context) {
    // ogr_style = 'PEN(c:#ff0000,w:0.13g,p:"2g 0.5g")'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('ogr_style')  == 'PEN(c:#ff0000,w:0.13g,p:"2g 0.5g")');
    } else {
        return (feature.get('ogr_style')  == 'PEN(c:#ff0000,w:0.13g,p:"2g 0.5g")');
    }
}
...
function exp_entitiesL_6rule13_eval_expression(context) {
    // ogr_style = 'PEN(c:#ff9100,w:0.13g)'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('ogr_style')  == 'PEN(c:#ff9100,w:0.13g)');
    } else {
        return (feature.get('ogr_style')  == 'PEN(c:#ff9100,w:0.13g)');
    }
}
...
function exp_entitiesL_8rule6_eval_expression(context) {
    // ogr_style = 'PEN(c:#803300,w:0.13g,p:"2g 0.5g")'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('ogr_style')  == 'PEN(c:#803300,w:0.13g,p:"2g 0.5g")');
    } else {
        return (feature.get('ogr_style')  == 'PEN(c:#803300,w:0.13g,p:"2g 0.5g")');
    }
}
...
function exp_entitiesL_8rule15_eval_expression(context) {
    // ogr_style = 'PEN(c:#ff7f00,w:0.13g,p:"0.5g 0.25g")'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('ogr_style')  == 'PEN(c:#ff7f00,w:0.13g,p:"0.5g 0.25g")');
    } else {
        return (feature.get('ogr_style')  == 'PEN(c:#ff7f00,w:0.13g,p:"0.5g 0.25g")');
    }
}
