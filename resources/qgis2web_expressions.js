...
function exp_entitiesL_3rule16_eval_expression(context) {
    // ogr_style = 'PEN(c:#dcdcdc,w:0.05g)'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('ogr_style')  == 'PEN(c:#dcdcdc,w:0.05g)');
    } else {
        return (feature.get('ogr_style')  == 'PEN(c:#dcdcdc,w:0.05g)');
    }
}
...
function exp_entitiesL_3rule18_eval_expression(context) {
    // ogr_style = 'PEN(c:#dcdcdc,w:0.15g)'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('ogr_style')  == 'PEN(c:#dcdcdc,w:0.15g)');
    } else {
        return (feature.get('ogr_style')  == 'PEN(c:#dcdcdc,w:0.15g)');
    }
}
...
function exp_entitiesL_3rule22_eval_expression(context) {
    // ogr_style = 'PEN(c:#dcdcdc,w:0.35g)'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('ogr_style')  == 'PEN(c:#dcdcdc,w:0.35g)');
    } else {
        return (feature.get('ogr_style')  == 'PEN(c:#dcdcdc,w:0.35g)');
    }
}
...
function exp_entitiesL_5rule11_eval_expression(context) {
...
function exp_entitiesL_5rule12_eval_expression(context) {
...
function exp_entitiesL_5rule13_eval_expression(context) {
...
function exp_entitiesL_5rule14_eval_expression(context) {
...
function exp_entitiesL_5rule15_eval_expression(context) {
    // ogr_style = 'PEN(c:#545454,w:0.18g)'
...
function exp_entitiesL_5rule16_eval_expression(context) {
...
function exp_entitiesL_5rule17_eval_expression(context) {
...
function exp_entitiesL_5rule18_eval_expression(context) {
...
function exp_entitiesL_5rule19_eval_expression(context) {
...
function exp_entitiesL_5rule20_eval_expression(context) {
    // ogr_style = 'PEN(c:#545454,w:0.2g)'
...
function exp_entitiesL_5rule21_eval_expression(context) {
    // ogr_style = 'PEN(c:#545454,w:0.35g)'
...
function exp_entitiesL_5rule22_eval_expression(context) {
...
function exp_entitiesL_5rule23_eval_expression(context) {
...
function exp_entitiesL_5rule24_eval_expression(context) {
    // ogr_style = 'PEN(c:#7f3f00)'
...
function exp_entitiesL_5rule25_eval_expression(context) {
...
function exp_entitiesL_5rule26_eval_expression(context) {
...
function exp_entitiesL_5rule27_eval_expression(context) {
...
function exp_entitiesL_5rule28_eval_expression(context) {
...
function exp_entitiesL_5rule29_eval_expression(context) {
    // ogr_style = 'PEN(c:#7f3f00,w:0.18g)'
...
function exp_entitiesL_5rule30_eval_expression(context) {
...
function exp_entitiesL_5rule31_eval_expression(context) {
    // ogr_style = 'PEN(c:#7f3f00,w:0.2g)'
...
function exp_entitiesL_5rule32_eval_expression(context) {
    // ogr_style = 'PEN(c:#7f3f00,w:0.35g)'
...
function exp_entitiesL_5rule33_eval_expression(context) {
...
function exp_entitiesL_5rule34_eval_expression(context) {
...
function exp_entitiesL_5rule35_eval_expression(context) {
...
function exp_entitiesL_5rule36_eval_expression(context) {
...
function exp_entitiesL_5rule37_eval_expression(context) {
...
function exp_entitiesL_5rule38_eval_expression(context) {
...
function exp_entitiesL_5rule39_eval_expression(context) {
...
function exp_entitiesL_5rule40_eval_expression(context) {
...
function exp_entitiesL_5rule41_eval_expression(context) {
    // ogr_style = 'PEN(c:#a5a500,w:0.18g)'
...
function exp_entitiesL_5rule42_eval_expression(context) {
...
function exp_entitiesL_5rule43_eval_expression(context) {
...
function exp_entitiesL_5rule44_eval_expression(context) {
...
function exp_entitiesL_5rule45_eval_expression(context) {
...
function exp_entitiesL_5rule46_eval_expression(context) {
    // ogr_style = 'PEN(c:#bf00ff,w:0.18g)'
...
function exp_entitiesL_5rule47_eval_expression(context) {
...
function exp_entitiesL_5rule48_eval_expression(context) {
...
function exp_entitiesL_5rule49_eval_expression(context) {
    // ogr_style = 'PEN(c:#bfbfbf,w:0.2g)'
...
function exp_entitiesL_5rule50_eval_expression(context) {
    // ogr_style = 'PEN(c:#dcdcdc)'
...
function exp_entitiesL_5rule51_eval_expression(context) {
...
function exp_entitiesL_5rule52_eval_expression(context) {
...
function exp_entitiesL_5rule53_eval_expression(context) {
    // ogr_style = 'PEN(c:#dcdcdc,w:0.13g)'
...
function exp_entitiesL_5rule54_eval_expression(context) {
...
function exp_entitiesL_5rule55_eval_expression(context) {
    // ogr_style = 'PEN(c:#dcdcdc,w:0.18g)'
...
function exp_entitiesL_5rule56_eval_expression(context) {
...
function exp_entitiesL_5rule57_eval_expression(context) {
    // ogr_style = 'PEN(c:#dcdcdc,w:0.2g)'
...
function exp_entitiesL_5rule58_eval_expression(context) {
...
function exp_entitiesL_5rule59_eval_expression(context) {
...
function exp_entitiesL_5rule60_eval_expression(context) {
...
function exp_entitiesL_5rule61_eval_expression(context) {
...
function exp_entitiesL_5rule62_eval_expression(context) {
...
function exp_entitiesL_5rule63_eval_expression(context) {
...
function exp_entitiesL_5rule64_eval_expression(context) {
...
function exp_entitiesL_5rule65_eval_expression(context) {
...
function exp_entitiesL_5rule66_eval_expression(context) {
...
function exp_entitiesL_5rule67_eval_expression(context) {
...
function exp_entitiesL_5rule68_eval_expression(context) {
...
function exp_entitiesL_5rule69_eval_expression(context) {
...
function exp_entitiesL_5rule70_eval_expression(context) {
    // ogr_style = 'PEN(c:#ff0000,w:0.18g)'
...
function exp_entitiesL_5rule71_eval_expression(context) {
...
function exp_entitiesL_5rule72_eval_expression(context) {
...
function exp_entitiesL_5rule73_eval_expression(context) {
...
function exp_entitiesL_5rule74_eval_expression(context) {
...
function exp_entitiesL_5rule75_eval_expression(context) {
...
function exp_entitiesL_5rule76_eval_expression(context) {
    // ogr_style = 'PEN(c:#ff0000,w:0.2g)'
...
function exp_entitiesL_5rule77_eval_expression(context) {
...
function exp_entitiesL_5rule78_eval_expression(context) {
...
function exp_entitiesL_5rule79_eval_expression(context) {
...
function exp_entitiesL_5rule80_eval_expression(context) {
...
function exp_entitiesL_5rule81_eval_expression(context) {
...
function exp_entitiesL_5rule82_eval_expression(context) {
...
function exp_entitiesL_5rule83_eval_expression(context) {
    // ogr_style = 'PEN(c:#ff7f00,w:0.18g)'
...
function exp_entitiesL_5rule84_eval_expression(context) {
...
function exp_entitiesL_5rule85_eval_expression(context) {
...
function exp_entitiesL_5rule86_eval_expression(context) {
...
function exp_entitiesL_5rule87_eval_expression(context) {
