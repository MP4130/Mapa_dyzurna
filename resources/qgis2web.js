...
var map = new ol.Map({
    ...
    view: new ol.View({
        ...
        projection: new ol.proj.Projection({
            code: 'EPSG:2177',
            //extent: [6568514.000000, 5564056.000000, 6579764.500000, 5570481.000000],
            units: 'm'
        })
    })
});
...
map.getView().fit([6567832.780708, 5563791.455504, 6580807.947375, 5570966.955504], map.getSize());
