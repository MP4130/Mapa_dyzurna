...
var map = new ol.Map({
    ...
    view: new ol.View({
        ...
        projection: new ol.proj.Projection({
            code: 'EPSG:2177',
            //extent: [6568525.000000, 5564068.500000, 6580237.000000, 5570512.500000],
            units: 'm'
        })
    })
});
...
map.getView().fit([6568149.982693, 5564033.447323, 6580553.649360, 5570573.947323], map.getSize());
