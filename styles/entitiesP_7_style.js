var size = 0;
var placement = 'point';
function categories_entitiesP_7(feature, value, size, resolution, labelText,
    ...
    switch(valueStr) {
        ...
        case '_wysokosci amsterdam teren PKP':
            return [ new ol.style.Style({
        image: new ol.style.Circle({radius: 0.2 + size,
            displacement: [0, 0], stroke: new ol.style.Stroke({color: 'rgba(35,35,35,0.5)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0.0}), fill: new ol.style.Fill({color: 'rgba(190,178,151,0.5)'})}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
...
var style_entitiesP_7 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = categories_entitiesP_7(feature, value, size, resolution, labelText,
...
var __GESUT2WEB_BASE_style_entitiesP_7 = style_entitiesP_7;

style_entitiesP_7 = function(feature, resolution) {

    var base = __GESUT2WEB_BASE_style_entitiesP_7(feature, resolution);
    var result = [];
