...
maxResolution:0.14002233076130982,
                ...
                interactive: true,
    title: 'Opisy / punkty' });
var format_zakres_9 = new ol.format.GeoJSON();
var features_zakres_9 = format_zakres_9.readFeatures(json_zakres_9, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_zakres_9 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_zakres_9.addFeatures(features_zakres_9);
var lyr_zakres_9 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_zakres_9, 
                style: style_zakres_9,
                popuplayertitle: 'zakres',
                interactive: true,
                title: '<img src="styles/legend/zakres_9.png" /> zakres'
            });
var group_4Katowiceszara2_CLIP_EXTRACT_POWER_COLORdxf_GPKGbyKat = new ol.layer.Group({
                                layers: [lyr_entitiesL_7,lyr_entitiesP_8,],
                                fold: 'close',
                                title: '4Katowice szara 2'});
var group_3Katowiceszara_CLIP_EXTRACT_POWER_COLORdxf_GPKGbyKat = new ol.layer.Group({
                                layers: [lyr_entitiesL_5,lyr_entitiesP_6,],
                                fold: 'close',
                                title: '3Katowice szara'});
var group_2pomiarynowychobiektw_CLIP_EXTRACT_POWER_COLORdxf_GPKGbyKat = new ol.layer.Group({
                                layers: [lyr_entitiesL_3,lyr_entitiesP_4,],
                                fold: 'close',
                                title: '2pomiary nowych obiektów'});
var group_1pomiaryistniejcychobiektw_CLIP_EXTRACT_POWER_COLORdxf_GPKGbyKat = new ol.layer.Group({
                                layers: [lyr_entitiesL_1,lyr_entitiesP_2,],
                                fold: 'close',
                                title: '1pomiary istniejących obiektów'});

lyr_google_0.setVisible(true);lyr_entitiesL_1.setVisible(true);lyr_entitiesP_2.setVisible(true);lyr_entitiesL_3.setVisible(true);lyr_entitiesP_4.setVisible(true);lyr_entitiesL_5.setVisible(true);lyr_entitiesP_6.setVisible(true);lyr_entitiesL_7.setVisible(true);lyr_entitiesP_8.setVisible(true);lyr_zakres_9.setVisible(true);
var layersList = [lyr_google_0,group_1pomiaryistniejcychobiektw_CLIP_EXTRACT_POWER_COLORdxf_GPKGbyKat,group_2pomiarynowychobiektw_CLIP_EXTRACT_POWER_COLORdxf_GPKGbyKat,group_3Katowiceszara_CLIP_EXTRACT_POWER_COLORdxf_GPKGbyKat,group_4Katowiceszara2_CLIP_EXTRACT_POWER_COLORdxf_GPKGbyKat,lyr_zakres_9];
...
lyr_zakres_9.set('fieldLabels', {});
lyr_zakres_9.on('precompose', function(evt) {
